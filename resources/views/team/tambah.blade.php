...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><strong>Klub /</strong> Tambah Klub</h1>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div
                ...
                <h1 class="text-center h2"> <b> Buat Klub Baru</b></h1>
            </div>
        </div>
    </div>
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                        name="name" placeholder="Masukkan Nama Klub..." required>
                </div>
            </div>
            @error('name')
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control @error('city') is-invalid @enderror" id="city"
                        name="city" placeholder="Masukkan Nama Kota..." required>
                </div>
            </div>
            @error('city')
                <div class="invalid-feedback">
